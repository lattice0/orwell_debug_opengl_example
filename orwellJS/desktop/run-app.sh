...
if [[ "$executor" == "ReactNetExecutor" ]]; then
  (node /home/lz/orwell_minimal_example/orwellJS/desktop/bin/ubuntu-server.js 2>&1 > /dev/null) &
fi
...
# Push binaries
  adb push /home/lz/orwell_minimal_example/orwellJS/desktop/bin/Orwell "$app_path/Orwell"
...
# Run app locally
  /home/lz/orwell_minimal_example/orwellJS/desktop/bin/Orwell $args
fi
